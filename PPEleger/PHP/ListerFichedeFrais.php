...
<body class="bodyListerFicheFrais">
    ...
    <div>
    <p class="listerFicheFrais-nom">Fiche de frais de : <?php echo $nomVisiteur ;?><a href='RenseignerFicheFrais.php'><img src="../img/+.png" alt="bouton ajouter" class="imgAjouter"></a> </p>
    </div>
...
$sqlDate1 = 'SELECT mois, annee, montantValide, idEtat, id FROM FicheFrais WHERE idVisiteur='.$idVisiteur.' AND id='.$id.';';
                        ...
                        while($userData = $sqlDate1 -> fetch_assoc()) {
                            ...
                            echo '<tr>
                                ...
                                <td> <a href="RenseignerFicheFraisModif.php?id='. $userData['id'] .'"><img src="../img/pencil.png" width=35px height=35px></a></td>
